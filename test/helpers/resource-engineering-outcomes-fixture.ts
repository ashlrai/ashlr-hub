...
export function cleanupEngineeringOutcomesFixtures(): void {
  vi.restoreAllMocks(); for (const root of roots.splice(0)) rmSync(root, { recursive: true, force: true });
}
export function engineeringOutcomesFixtureTree(root: string): string {
...
export function createEngineeringOutcomesFixture() {
