...
export const REAL_IO_TEST_FILES = [
  ...
  'test/m506.host-auto-merge-e2e.test.ts', // real git worktree/merge/apply subprocess work — 10.3s slowest test in the quiet baseline
  'test/m520.full-chain-merge-e2e.test.ts', // real git worktree/merge/apply subprocess work — 8.1s slowest test in the quiet baseline
