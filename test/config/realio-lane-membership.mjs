...
export const REAL_IO_TEST_FILES = [
  'test/preparation-batch-source.test.ts', // exact reverse/forward Git patch proof in private scratch
  'test/release-configured-coverage.test.ts', // actual configured Vitest sequencing in private sentinel fixtures
  'test/release-vitest-partition.test.ts', // real config discovery and resolved execution-setting parity
  ...
  'test/resource-pool-state-reader.test.ts', // checked installed-header snapshots and private source/archive custody
  'test/resource-engineering-outcomes-archive.test.ts', // real archived accounting and between-sample continuity
